...
function Dashboard() {
  ...
  const getAllExpenses = async () => {
    try {
      ...
      .from(Budgets) // Corrected from Budgets to Expenses
      .rightJoin(Expenses,eq(Budgets.id,Expenses.budgetId))
      .where(eq(Expenses.createdBy, user?.primaryEmailAddress?.emailAddress)) // Corrected table reference
  ...
  return (
    <div className='p-8'>
      <h2 className='font-bold text-3xl'>Hello, {user?.fullName} User!</h2>
